...
class HomeViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.comment.addTarget(self, action:#selector(handleComment(_:forEvent:)), for: .touchUpInside)
    ...
    @objc func handleComment(_ sender: UIButton, forEvent event: UIEvent) {
        ...
        commentViewController.indexPathRow = indexPath!.row
        commentViewController.postArray = postArray
